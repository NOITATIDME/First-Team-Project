      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <div class="border border-info p-4 rounded">
            ...
            <!-- 새글쓰기 버튼 -->
            <button type="button" class="btn btn-primary btn-sm float-right my-3" onclick="location.href = '/board/boardWrite.html';">
            ...
            <table class="table table-hover" id="board">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="/board/boardContent.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
                  </td>
